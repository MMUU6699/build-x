...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        class="flex h-7 w-7 items-center justify-center cursor-pointer rounded-md hover:bg-[var(--fill-tsp-gray-main)] absolute top-[18px] ltr:right-[20px] rtl:left-[20px] !end-3 !md:end-4"
      >
