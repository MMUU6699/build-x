export default {
  ...
  'Visit': 'Visit',
  'Preview': 'Preview',
  'Send to Build X': 'Send to Build X',
  'Failed to send file to Build X': 'Failed to send file to Build X',
  ...
  'Give Build X a task...': 'Give Build X a task...',
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Build X Computer': 'Build X Computer',
  "Build X's Computer": "Build X's Computer",
  "{name}'s computer": "{name}'s computer",
  "{name}'s computer is inactive": "{name}'s computer is inactive",
  'Build X is using': 'Build X is using',
  ...
  'Give Build X a task to work on...': 'Give Build X a task to work on...',
  'Send message to Build X': 'Send message to Build X',
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Build X': 'Login to Build X',
  'Register to Build X': 'Register to Build X',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Build X': 'Registration successful! Welcome to Build X',
  // OAuth Login
  ...
  'OAuth login failed, please try again': 'OAuth login failed, please try again',
  'OAuth login expired, please try again': 'OAuth login expired, please try again',
  ...
  'Nickname': 'Nickname',
  'Manage your identity information for Build X.': 'Manage your identity information for Build X.',
  'Build X uses this information to personalize responses.': 'Build X uses this information to personalize responses.',
  ...
  'You are viewing a completed Build X task. Replay will start automatically in {countdown} seconds.': 'You are viewing a completed Build X task. Replay will start automatically in {countdown} seconds.',
  'Build X task replay completed.': 'Build X task replay completed.',
  'Build X is replaying the task...': 'Build X is replaying the task...',
  'Replay': 'Replay',
  ...
  'Chat Freely via Build X': 'Chat Freely via Build X',
  ...
  'Create Build X Claw': 'Create Build X Claw',
  'One-click OpenClaw deployment by Build X': 'One-click OpenClaw deployment by Build X',
  'Creating...': 'Creating...',
