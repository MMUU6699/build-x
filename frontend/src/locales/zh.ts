export default {
  ...
  'Visit': '访问',
  'Preview': '预览',
  'Send to Build X': '发给 Build X',
  'Failed to send file to Build X': '发送文件给 Build X 失败',
  'Search files': '搜索文件',
  'Grid view': '网格视图',
  'List view': '列表视图',
  'Documents': '文档',
  ...
  'Give Build X a task...': '给 Build X 一个任务...',
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'Build X Computer': 'Build X 的电脑',
  "Build X's Computer": 'Build X 的电脑',
  "{name}'s computer": '{name} 的电脑',
  "{name}'s computer is inactive": '{name} 的电脑当前未活动',
  'Build X is using': 'Build X 正在使用',
  ...
  'Give Build X a task to work on...': '给 Build X 一个任务...',
  'Send message to Build X': '给 Build X 发消息...',
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to Build X': '登录 Build X',
  'Register to Build X': '注册 Build X',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Signing in...': '正在登录...',
  'OAuth is not configured': 'OAuth 未配置',
  'OAuth login failed, please try again': 'OAuth 登录失败，请重试',
  'OAuth login expired, please try again': 'OAuth 登录已过期，请重试',
  'Already have an account?': '已有账户？',
  'Don\'t have an account?': '没有账户？',
  'Login successful! Welcome back': '登录成功！欢迎回来',
  'Registration successful! Welcome to Build X': '注册成功！欢迎使用 Build X',
  ...
  'Nickname': '昵称',
  'Manage your identity information for Build X.': '管理您的身份信息。',
  'Build X uses this information to personalize responses.': 'Build X 使用此信息为所有任务定制响应。',
  ...
  'You are viewing a completed Build X task. Replay will start automatically in {countdown} seconds.': '您正在查看一个已完成的 Build X 任务。回放将在 {countdown} 秒后自动开始。',
  'Build X task replay completed.': 'Build X 任务回放完成。',
  'Build X is replaying the task...': 'Build X 正在回放任务...',
  'Replay': '重放',
  ...
  'Chat Freely via Build X': '通过 Build X 自由对话',
  ...
  'Get Started': '立即开始',
  'Create Build X Claw': '创建 Build X Claw',
  'One-click OpenClaw deployment by Build X': 'Build X 帮你一键部署的 OpenClaw',
  'Creating...': '创建中...',
