...
// Removed provider functionality
// Removed provider functionality
...
class _DesktopSettingsPageState extends State<DesktopSettingsPage> {
  ...
  void initState() {
    super.initState();
    // Removed providers functionality
  }
      ...
      trailing: Row(
        ...
        children: [
          ...
          Tooltip(
            ...
            child: IconButton(
              icon: Icon(lucide.Lucide.RotateCcw),
              onPressed: () async {
                await context.read<SettingsProvider>().clearAppFont();
              },
            ),
              ...
              return Column(
                ...
                children: [
                  Row(children: [
                    ...
                    IconButton(icon: Icon(lucide.Lucide.X), onPressed: () => Navigator.of(ctx).maybePop()),
                  ]),
