"""
OpenAI-compatible API proxy for build-x-claw.
...
async def chat_completions(request: Request):
    ...
    Authenticates using per-user Build X API keys and forwards to the configured LLM backend.
    """
    ...
    if settings.model_name and body.get("model") in ("default", "build-x-proxy/default", None):
